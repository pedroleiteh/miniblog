...
import { seAuthValue, useAuthValue } from '../../context/AuthContext'
    ...
    <div className={styles.create_post}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label>
          ...
          <input type="text" name="image" required placeholder="Insira uma imagem aqui" onChange={e => setImage(e.target.value)} value={image} />
        </label>
        <label>
          <span>Conteúdo</span>
